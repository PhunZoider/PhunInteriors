...
#
# -- and `perl scripts/roomcheck.pl` is what checks it against the lotpacks. Run
...
#
#   perl scripts/gendefaults.pl            write the file
#   perl scripts/gendefaults.pl --stdout   print it instead
# ---------------------------------------------------------------------------
use strict;
use warnings;
use Text::ParseWords;
...
--
-- GENERATED by scripts/gendefaults.pl from Docs/pi-assigned.csv,
...
-- no arithmetic describes it. `perl scripts/roomcheck.pl` is what checks either
